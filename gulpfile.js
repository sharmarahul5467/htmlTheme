...
exports.start = series(parallel(html, js, css, images), parallel(refreshPage, watchFiles));
exports.build = series(clean, parallel(html, js, css, images), watchFiles);
exports.default = series(parallel(html, js, css, images), parallel(refreshPage, watchFiles));;
